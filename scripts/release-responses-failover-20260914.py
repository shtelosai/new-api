"""Responses 故障切换发布：逐阶段校验提交、备份、在途排空与镜像身份。"""
import hashlib,json,os,re,shutil,subprocess,sys,time,urllib.request
from pathlib import Path

os.umask(0o077)
ROOT=Path('/www/twork/releases/responses-failover-20260914')
BACKUP=ROOT/'backup'
...
CANDIDATE='new-api-twork-responses-failover-20260914'
IMAGE='new-api:twork-responses-failover-20260914'
...
def health(port):
    ...
    assert result.get('success') and result['data']['version']=='twork-responses-failover-20260914'
